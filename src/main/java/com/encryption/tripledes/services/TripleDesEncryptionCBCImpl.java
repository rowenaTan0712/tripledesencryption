...
@Service
public class TripleDesEncryptionCBCImpl implements TripleDesEncryptionCBCService{
    ...
    private static final Logger logger = LogManager.getLogger(TripleDesEncryptionCBCImpl.class.getName());
